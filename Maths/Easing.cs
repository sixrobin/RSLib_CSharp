namespace RSLib.CSharp.Maths
{
	...
	/// <summary>
	/// Methods representing some easing curves where t is clamped between 0 and 1.
	/// Warning: some of the methods below will return a result below 0 or above 1, such as back easing.
