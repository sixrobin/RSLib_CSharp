namespace RSLib.CSharp.Maths
{
    public static class Maths
    {
        ...
        public static int QuadraticEquation(float a, float b, float c, out float r1, out float r2)
        {
            ...
            r1 = (-b + System.MathF.Sqrt(delta)) / (2f * a);
            r2 = (-b - System.MathF.Sqrt(delta)) / (2f * a);
        ...
        {
            return Remap(x, r1Min, r1Max, r2Min, r2Max).Clamp(r2Min, r2Max);
        }
        ...
        {
            return Normalize(x, rMin, rMax).Clamp01();
        }
        ...
        #endregion // REMAPPING/NORMALIZATION
